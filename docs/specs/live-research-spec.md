...
| **Real Persona E2E** | `mock_bab=false` + 真實 retrieval + 真實 BAB + 真實 persona reply | 測試 persona 全程真實 | 高（~$5） | ✅ release 前 ≥ 1 次 |
...
*最後 code re-sync：2026-06-19（`main`）。本文已從歷史/未實作設計脂肪瘦身為純契約文件；新人導覽見 `docs/reference/lr-onboarding.md`。*
